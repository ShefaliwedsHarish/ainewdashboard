      ...
      <div className="progress-banner">
        <div className="pb-left">
          ...
          <div className="pb-bar-meta">
            <span>6 of 9 sections complete</span>
            <span>Last saved 2 min ago</span>
          </div>
        </div>
        <div className="pb-right">
          <div className="pb-pct">67%</div>
          ...
          <div className="wizard-nav-section">
            ...
            <div className="wizard-step">
              ...
              <div className="step-content">
                <div className="step-title">Business profile</div>
                <div className="step-desc">Name, address, contact</div>
              </div>
            </div>

            <div className="wizard-step active">
              <div className="step-status active">2</div>
              <div className="step-content">
                <div className="step-title">Services & offers</div>
                <div className="step-desc">What you sell</div>
              </div>
            </div>
            ...
            <div className="wizard-step">
              ...
              <div className="step-content">
                <div className="step-title">Trading hours</div>
                <div className="step-desc">When you're open</div>
              </div>
            </div>
            ...
            <div className="wizard-step">
              ...
              <div className="step-content">
                <div className="step-title">Team & routing</div>
                <div className="step-desc">Who handles what</div>
              </div>
            </div>
            ...
            <div className="wizard-step">
              ...
              <div className="step-content">
                <div className="step-title">Voice & tone</div>
                <div className="step-desc">How Lyraa sounds</div>
              </div>
            </div>
            ...
            <div className="wizard-step">
              ...
              <div className="step-content">
                <div className="step-title">Greeting & disclosure</div>
                <div className="step-desc">Opening script</div>
              </div>
            </div>

            <div className="wizard-step">
              <div className="step-status pending">7</div>
              <div className="step-content">
                <div className="step-title">Knowledge documents</div>
                <div className="step-desc">Upload PDFs, docs</div>
              </div>
            </div>

            <div className="wizard-step">
              <div className="step-status pending">8</div>
              <div className="step-content">
                <div className="step-title">Common questions</div>
                <div className="step-desc">FAQs & answers</div>
              </div>
            </div>
            ...
            <div className="wizard-step">
              ...
              <div className="step-content">
                <div className="step-title">Escalation rules</div>
                <div className="step-desc">When to hand off</div>
              </div>
            </div>
        ...
        <div className="wizard-content">
          ...
          <div className="wc-header">
            <div className="wc-title-block">
              <div className="wc-eyebrow">Step 2 of 9</div>
              <div className="wc-title">
                Services & offers
                <span className="wc-title-pill">In progress</span>
              </div>
              <div className="wc-subtitle">List the services you offer so Lyraa can answer pricing, scope, and availability questions accurately.</div>
            </div>
          ...
          <div className="form-body">
            ...
            <div className="form-section">
              ...
              <div className="hours-row" style={{gridTemplateColumns: '1fr auto', padding: '10px 0', borderBottom: '0.5px solid rgba(83, 74, 183, 0.08)'}}>
                <div>
                  <div style={{fontSize: '13px', color: 'var(--lyraa-deep)', fontWeight: '600'}}>Never quote firm prices on call</div>
                  <div style={{fontSize: '11.5px', color: 'var(--lyraa-fog)', marginTop: '2px'}}>Lyraa will collect details and route to estimator.</div>
                </div>
              ...
              <div className="hours-row" style={{gridTemplateColumns: '1fr auto', padding: '10px 0', borderBottom: '0.5px solid rgba(83, 74, 183, 0.08)'}}>
                <div>
                  <div style={{fontSize: '13px', color: 'var(--lyraa-deep)', fontWeight: '600'}}>Always disclose AI receptionist</div>
                  <div style={{fontSize: '11.5px', color: 'var(--lyraa-fog)', marginTop: '2px'}}>Required for EU/UK callers. Recommended everywhere.</div>
                </div>
                <div className="toggle on"></div>
              </div>
              ...
              <div className="hours-row" style={{gridTemplateColumns: '1fr auto', padding: '10px 0', borderBottom: '0.5px solid rgba(83, 74, 183, 0.08)'}}>
                <div>
                  <div style={{fontSize: '13px', color: 'var(--lyraa-deep)', fontWeight: '600'}}>Escalate complaints immediately</div>
                  <div style={{fontSize: '11.5px', color: 'var(--lyraa-fog)', marginTop: '2px'}}>Any complaint triggers same-day callback flag.</div>
                </div>
                <div className="toggle on"></div>
              </div>

              <div className="hours-row" style={{gridTemplateColumns: '1fr auto', padding: '10px 0'}}>
                <div>
                  <div style={{fontSize: '13px', color: 'var(--lyraa-deep)', fontWeight: '600'}}>Allow technical scope discussion</div>
                  <div style={{fontSize: '11.5px', color: 'var(--lyraa-fog)', marginTop: '2px'}}>Lyraa can discuss tech stack at high level if asked.</div>
                </div>
            ...
            <div className="form-section">
              ...
              <div className="voice-grid">
                <div className="voice-card selected">
                  <div className="voice-card-header">
                    <div className="voice-orb amber"></div>
                    <div className="voice-info">
                      <div className="voice-name">Olivia</div>
                      <div className="voice-tag">AU · Warm & professional</div>
                    </div>
                ...
                <div className="voice-card">
                  <div className="voice-card-header">
                    <div className="voice-orb purple"></div>
                    <div className="voice-info">
                      <div className="voice-name">James</div>
                      <div className="voice-tag">AU · Confident & clear</div>
                    </div>
                    <div className="voice-play">
                      <svg width="9" height="9" viewBox="0 0 24 24" fill="currentColor"><polygon points="5 3 19 12 5 21 5 3"/></svg>
                    </div>
                ...
                <div className="voice-card">
                  <div className="voice-card-header">
                    <div className="voice-orb teal"></div>
                    <div className="voice-info">
                      <div className="voice-name">Mia</div>
                      <div className="voice-tag">AU · Friendly & casual</div>
                    </div>
                    <div className="voice-play">
                      <svg width="9" height="9" viewBox="0 0 24 24" fill="currentColor"><polygon points="5 3 19 12 5 21 5 3"/></svg>
                    </div>
